...
<script type="application/json" data-for="htmlwidget-f92095f51f042d8cbb42">{"x":{"html":"<ul>\n  <li>re<span class='match'>cei<\/span>ve<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
``` r
...
```
    ...
    ## [1] "HPRFX" "IQDTI" "JIMTY" "YRTFA" "PRUPN"
