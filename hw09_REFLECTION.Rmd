...
Admittedly, naming a package [hw09]() is not very inspired, but you get the gist, click on the link to be taken to my r package!
...
create a unique, (somewhat) helpful function

document the function using roxygen2

added an accompanying dataset so the user (or peer review) can test out my package

update the description file to include the developer, brief package description, and package dependencies 

update the licensing information so others can use my package without worry, this includes making a new file in the project repository called LICENSE

create a test file that assures the function actually works

Update the vignette file that will accompany my package with useful and necessary information for the user
