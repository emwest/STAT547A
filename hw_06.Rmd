...
Some background on regular expressions: a regular expression \n is simply a pattern describing a string of characters. A regular expression is used to match 0-n characters in a string. A regular expression can include digits and letters which will match to themselves. Metacharacters are characters with special meaning including \ $ . [ { etc, to match a metacharacter it must be preceded with a backslash.
